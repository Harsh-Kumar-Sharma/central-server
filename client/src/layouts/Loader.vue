<template>
    <div class="loader">
        <svg class="car" width="150" height="50" xmlns="http://www.w3.org/2000/svg">
            <g transform="translate(2 1)" stroke="#ffffff" fill="none" fill-rule="evenodd" stroke-linecap="round"
