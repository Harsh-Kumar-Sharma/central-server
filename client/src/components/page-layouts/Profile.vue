    ...
    <div class="card-body pt-9 pb-0">
      ...
      <div class="d-flex overflow-auto h-55px">
        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold flex-nowrap">
          <!--begin::Nav item-->
          <li class="nav-item">
            <router-link to="/crafted/pages/profile/overview" class="nav-link text-active-primary me-6"
              active-class="active">
              Overview
            </router-link>
          </li>
          ...
          <!--begin::Nav item-->
          <li class="nav-item">
            <router-link class="nav-link text-active-primary me-6" to="/crafted/pages/profile/projects"
              active-class="active">
              Projects
            </router-link>
          </li>
          ...
          <!--begin::Nav item-->
          <li class="nav-item">
            <router-link class="nav-link text-active-primary me-6" to="/crafted/pages/profile/campaigns"
              active-class="active">
              Campaigns
            </router-link>
          </li>
          ...
          <!--begin::Nav item-->
          <li class="nav-item">
            <router-link class="nav-link text-active-primary me-6" to="/crafted/pages/profile/documents"
              active-class="active">
              Documents
            </router-link>
          </li>
          ...
          <!--begin::Nav item-->
          <li class="nav-item">
            <router-link class="nav-link text-active-primary me-6" to="/crafted/pages/profile/connections"
              active-class="active">
              Connections
            </router-link>
          </li>
          ...
          <!--begin::Nav item-->
          <li class="nav-item">
            <router-link class="nav-link text-active-primary me-6" to="/crafted/pages/profile/activity"
              active-class="active">
              Activity
            </router-link>
          </li>
