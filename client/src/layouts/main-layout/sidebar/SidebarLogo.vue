  ...
  <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
    <router-link to="/dashboard">
      <img v-if="layout === 'dark-sidebar' ||
        ...
        " alt="Logo" src="../../../assets/images/nhai.png" class="h-25px app-sidebar-logo-default" />
      <img v-if="themeMode === 'light' && layout === 'light-sidebar'" alt="Logo" src="../../../assets/images/nhai.png"
        class="h-25px app-sidebar-logo-default" />
      <img alt="Logo" src="../../../assets/images/nhai.png" class="h-20px app-sidebar-logo-minimize" />
    </router-link>
