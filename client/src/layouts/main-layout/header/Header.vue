  ...
  <div id="kt_app_header" v-if="headerDisplay" class="app-header">
    ...
    <div class="app-container d-flex align-items-stretch justify-content-between" :class="{
      ...
      <div v-if="layout === 'light-header' || layout === 'dark-header'"
        ...
        <router-link to="/">
          <img v-if="themeMode === 'light' && layout === 'light-header'" alt="Logo" src="../../../assets/images/nhai.png"
          ...
          <img v-if="layout === 'dark-header' ||
            ...
            " alt="Logo" src="../../../assets/images/nhai.png" class="h-20px h-lg-30px app-sidebar-logo-default" />
        </router-link>
      </div>
      <template v-else>
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
          <router-link to="/" class="d-lg-none">
            <img alt="Logo" src="../../../assets/images/nhai.png" class="h-30px" />
          </router-link>
        </div>
        <!--end::Mobile logo-->
      </template>
