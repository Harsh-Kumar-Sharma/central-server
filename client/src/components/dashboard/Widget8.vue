<template>
    ...
    <div :class="widgetClasses" class="card" style="height: 620px">
        <div class="card-header border-0 mb-xl-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bold fs-3 mb-1">
                    Revenue Vehicle Classification
                </span>
            </h3>
        </div>
...
export default defineComponent({
    ...
    methods: {
        async getChartData() {
            if (this.getTransactionStatus.getRevenueData) {
                this.loader = false;
                this.vehicleData = this.getTransactionStatus.getRevenueData;
